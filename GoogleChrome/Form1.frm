...
If startdir$ <> "" Then
   If ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "false" Or ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "" Then
         WritePrivateProfileString "Aja", "exe", "start.exe /unix /usr/bin/google-chrome  " + Command$, startdir$ + "\aja.ini"
         ...
         WritePrivateProfileString "Aja", "aktivoi", "Google Chrome", startdir$ + "\aja.ini"
    End If
End If
End Sub
...
If startdir$ <> "" Then
   If ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "false" Or ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "" Then
         WritePrivateProfileString "Aja", "exe", "/usr/bin/google-chrome  " + Command$, startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "path", "c:\windows\command", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "start", "true", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "system", "unix", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "aktivoi", "Google Chrome", startdir$ + "\aja.ini"
    End If
End If
    If ReadINI("Google Chrome", "Lock", "", startdir$ + "\aja.ini") <> "True" Then
         WritePrivateProfileString "Google Chrome", "Lock", "True", startdir$ + "\aja.ini"
    Else
...
If vastaus <> vbYes Then
    ...
    Cancel = True
Else
    WritePrivateProfileString "Google Chrome", "Lock", "False", startdir$ + "\aja.ini"
End If
End Sub
