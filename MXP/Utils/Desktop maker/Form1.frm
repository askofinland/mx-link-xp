...
Private Sub Command2_Click()
    ...
    iconLinuxPath = Replace(Mid$(bmpPath, 3), "\", "/")
    iniLinuxPath = Replace(Mid$(iniPath, 3), "\", "/")
    ...
    desktopEntry = desktopEntry & "Exec=/usr/bin/iniwriter " & iniLinuxPath & " /home/" & Text3.Text & "/ramdisk/aja.ini" & vbCrLf
