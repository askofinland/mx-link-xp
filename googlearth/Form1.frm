...
If startdir$ <> "" Then
   If ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "false" Or ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "" Then
         WritePrivateProfileString "Aja", "exe", "start.exe /unix /usr/bin/google-earth-pro ", startdir$ + "\aja.ini"
         ...
         WritePrivateProfileString "Aja", "aktivoi", "earth", startdir$ + "\aja.ini"
...
If startdir$ <> "" Then
   ...
   If ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "false" Or ReadINI("Aja", "start", "", startdir$ + "\aja.ini") = "" Then
         WritePrivateProfileString "Aja", "exe", "/usr/bin/google-earth-pro", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "path", "c:\windows\command", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "start", "true", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "system", "unix", startdir$ + "\aja.ini"
         WritePrivateProfileString "Aja", "aktivoi", "earth", startdir$ + "\aja.ini"
    End If
    If ReadINI("Earth", "Lock", "", startdir$ + "\aja.ini") <> "True" Then
         WritePrivateProfileString "Earth", "Lock", "True", startdir$ + "\aja.ini"
    Else
        End
    End If
...
If vastaus <> vbYes Then
    ...
    Cancel = True
Else
         WritePrivateProfileString "earth", "Lock", "False", startdir$ + "\aja.ini"
End If
End Sub
